...
@NamedQueries({
        ...
        @NamedQuery(name = Meal.UPDATE, query = "UPDATE Meal SET id = :id, dateTime = :dateTime, description = :description, calories = :calories" +
...
public class Meal extends AbstractBaseEntity {
    ...
    @NotBlank
    @Size(min = 2, max = 120, message = "Description length min=2, max=120")
    private String description;

    @Column(name = "calories", nullable = false)
    @Range(min = 10, max = 5000, message = "Calories min=10, max = 5000")
